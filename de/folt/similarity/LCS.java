 ...
 * Modification: Klemens Waldhör, 2013
 * 
...
public class LCS
{
	...
	public static MatchSimilarity LCSAlgorithm(String a, String b)
	{
		int n = a.length();
		int m = b.length();
		...
		String lcsMatch = new String(lcs);
		try
		{
			similarity = lcsMatch.length()*100 / (Math.max(a.length(), b.length()));
		}
		catch (Exception e)
		{
			similarity = 0;
		...
		MatchSimilarity match = new MatchSimilarity(lcsMatch, similarity);
	...
	public static void main(String args[])
	{
		try
		{
			...
			System.out.println(LCSAlgorithm("Das ist ein Haus", "Das ist mein Haus").getSimilarity());
			System.out.println(LCSAlgorithm("Das ist dein Haus", "Das ist nicht mein Haus").getSimilarity());
			System.out.println(LCSAlgorithm("Dort ist ein Haus", "Das ist mein Haus").getSimilarity());
			System.out.println(LCSAlgorithm("", "Das ist mein Haus").getSimilarity());
			System.out.println(LCSAlgorithm("", "").getSimilarity());
		}
		catch (Exception e)
		{
			e.printStackTrace();
