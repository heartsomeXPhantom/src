...
public class DeleteOpenTMSDataSource implements RPCMessage
{
    ...
    public Vector execute(Hashtable message)
    {
        ...
        try
        {
            ...
            // ok - call now a function which deletes the database
            @SuppressWarnings("unused")
            ...
            @SuppressWarnings("unused")
            String filePath = EMXProperties.getInstance().getEMXProperty("database.path");
            ...
            @SuppressWarnings("unused")
            Vector retVec = com.araya.OpenTMS.Interface.runDeleteDB(message);
