...
public class About extends Dialog
{
    ...
    private XliffEditor xliffEditor = new XliffEditor();
    ...
    /**
     * @param xliffEditor the xliffEditor to set
     */
    ...
    public About(Shell parent)
    {
        ...
        shell.setText(message.getString("About") + message.getString("Docliff_Editor") + " " + version); //$NON-NLS-1$
